...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::hello::hello_cloud_is_enrolled,
            commands::hello::hello_cloud_store,
            commands::hello::hello_cloud_retrieve,
            commands::hello::hello_cloud_clear,
            commands::cloud::cloud_signup,
            commands::cloud::cloud_login,
            commands::cloud::cloud_recover,
            commands::cloud::cloud_list_vaults,
            commands::cloud::cloud_open_vault,
            commands::cloud::cloud_create_vault,
            commands::cloud::cloud_rename_vault,
            commands::cloud::cloud_delete_vault,
